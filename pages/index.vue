    ...
    <div class="flex-1 flex overflow-y-auto">
      <div class="flex flex-col" style="flex-basis: 310px">
        <div class="card flex flex-col items-center justify-center" style="flex-basis: 160px">
          ...
          <p class="text-red-100 font-semibold text-7xl" style="line-height: 6.125rem">76,787</p>
        </div>
        <div class="card flex-1 my-2 flex flex-col overflow-y-auto">
          ...
          <ul class="overflow-y-auto custom-scrollbar">
            <li v-for="country in countries" :key="country.name" class="capitalize flex items-center border-b border-gray-400 py-2">
        ...
        <div class="card" style="flex-basis: 80px"></div>
      </div>
      <div class="card flex-1 mx-2"></div>
      <div class="flex flex-col" style="flex-basis: 550px">
        <div class="flex-1 flex mb-2">
          <div class="card flex-1 mr-2">1</div>
          <div class="card flex-1">2</div>
        </div>
...
.card {
  @apply bg-gray-100 border border-a-gray-100 px-5 py-2;
}
</style>
